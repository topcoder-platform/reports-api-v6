  ...
  challenges: {
    ...
    reports: [
      ...
      challengeReport(
        ...
        "Return the challenge submitters report. Marathon Match exports use the latest non-failed provisionalScore and include finalScore/finalRank only after final scoring is available for completed challenges.",
      ...
      challengeReport(
        ...
        "Return the challenge valid submitters report. Marathon Match exports use the latest non-failed provisionalScore and include finalScore/finalRank only after final scoring is available for completed challenges.",
